...
public class QuiltingDataController {
    ...
    public ModelAndView addQuiltingReport(@Valid QuiltingReportWrapper quiltingReportWrapper, BindingResult result, ModelAndView model) {
        ...
        if (quiltingReportWrapper.getPickerId() > 0) {
            handleAddingIndicesOfQuilter(quiltedIndices, 1, quiltingReportWrapper, pickerQ1, quiltingData);
        } else if (quiltingReportWrapper.isAnyOfFieldsNull(1)) {
            return fillQuiltingReportModel(quiltingReportWrapper, model);
        }
        //second quilter
        if (quiltingReportWrapper.getPicker2Id() > 0) {
            handleAddingIndicesOfQuilter(quiltedIndices, 2, quiltingReportWrapper, pickerQ2, quiltingData);
        } else if (quiltingReportWrapper.isAnyOfFieldsNull(2)) {
            return fillQuiltingReportModel(quiltingReportWrapper, model);
        }
        //third quilter
        if (quiltingReportWrapper.getPicker3Id() > 0) {
            handleAddingIndicesOfQuilter(quiltedIndices, 3, quiltingReportWrapper, pickerQ3, quiltingData);
        } else if (quiltingReportWrapper.isAnyOfFieldsNull(3)) {
            return fillQuiltingReportModel(quiltingReportWrapper, model);
        }
    ...
    private void handleAddingIndicesOfQuilter(List<QuiltedIndex> listToModify, int quilterNumber,
                                              QuiltingReportWrapper quiltingReportWrapper, ProductionWorker picker,
                                              QuiltingData quiltingData) {
        switch (quilterNumber) {
            case (1):
                if (quiltingReportWrapper.getMa75() != null && quiltingReportWrapper.getMa75() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MALFORS_75.toString(), quiltingReportWrapper.getMa75(), quiltingReportWrapper.getMa75o(), picker, quiltingData, 1));
                }
                if (quiltingReportWrapper.getMa80() != null && quiltingReportWrapper.getMa80() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MALFORS_80.toString(), quiltingReportWrapper.getMa80(), quiltingReportWrapper.getMa80o(), picker, quiltingData, 1));
                }
                if (quiltingReportWrapper.getMa90() != null && quiltingReportWrapper.getMa90() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MALFORS_90.toString(), quiltingReportWrapper.getMa90(), quiltingReportWrapper.getMa90o(), picker, quiltingData, 1));
                }
                if (quiltingReportWrapper.getMa140() != null && quiltingReportWrapper.getMa140() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MALFORS_140.toString(), quiltingReportWrapper.getMa140(), quiltingReportWrapper.getMa140o(), picker, quiltingData, 1));
                }
                if (quiltingReportWrapper.getMa160() != null && quiltingReportWrapper.getMa160() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MALFORS_160.toString(), quiltingReportWrapper.getMa160(), quiltingReportWrapper.getMa160o(), picker, quiltingData, 1));
                }
                if (quiltingReportWrapper.getMo75() != null && quiltingReportWrapper.getMo75() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MOSHULT_75.toString(), quiltingReportWrapper.getMo75(), quiltingReportWrapper.getMo75o(), picker, quiltingData, 1));
                }
                if (quiltingReportWrapper.getMo80() != null && quiltingReportWrapper.getMo80() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MOSHULT_80.toString(), quiltingReportWrapper.getMo80(), quiltingReportWrapper.getMo80o(), picker, quiltingData, 1));
                }
                if (quiltingReportWrapper.getMo90() != null && quiltingReportWrapper.getMo90() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MOSHULT_90.toString(), quiltingReportWrapper.getMo90(), quiltingReportWrapper.getMo90o(), picker, quiltingData, 1));
                }
                if (quiltingReportWrapper.getMo140() != null && quiltingReportWrapper.getMo140() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MOSHULT_140.toString(), quiltingReportWrapper.getMo140(), quiltingReportWrapper.getMo140o(), picker, quiltingData, 1));
                }
                if (quiltingReportWrapper.getMo160() != null && quiltingReportWrapper.getMo160() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MOSHULT_160.toString(), quiltingReportWrapper.getMo160(), quiltingReportWrapper.getMo160o(), picker, quiltingData, 1));
                }
                break;
            case (2):
                if (quiltingReportWrapper.getMa752() != null && quiltingReportWrapper.getMa752() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MALFORS_75.toString(), quiltingReportWrapper.getMa752(), quiltingReportWrapper.getMa75o2(), picker, quiltingData, 2));
                }
                if (quiltingReportWrapper.getMa802() != null && quiltingReportWrapper.getMa802() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MALFORS_80.toString(), quiltingReportWrapper.getMa802(), quiltingReportWrapper.getMa80o2(), picker, quiltingData, 2));
                }
                if (quiltingReportWrapper.getMa902() != null && quiltingReportWrapper.getMa902() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MALFORS_90.toString(), quiltingReportWrapper.getMa902(), quiltingReportWrapper.getMa90o2(), picker, quiltingData, 2));
                }
                if (quiltingReportWrapper.getMa1402() != null && quiltingReportWrapper.getMa1402() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MALFORS_140.toString(), quiltingReportWrapper.getMa1402(), quiltingReportWrapper.getMa140o2(), picker, quiltingData, 2));
                }
                if (quiltingReportWrapper.getMa1602() != null && quiltingReportWrapper.getMa1602() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MALFORS_160.toString(), quiltingReportWrapper.getMa1602(), quiltingReportWrapper.getMa160o2(), picker, quiltingData, 2));
                }
                if (quiltingReportWrapper.getMo752() != null && quiltingReportWrapper.getMo752() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MOSHULT_75.toString(), quiltingReportWrapper.getMo752(), quiltingReportWrapper.getMo75o2(), picker, quiltingData, 2));
                }
                if (quiltingReportWrapper.getMo802() != null && quiltingReportWrapper.getMo802() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MOSHULT_80.toString(), quiltingReportWrapper.getMo802(), quiltingReportWrapper.getMo80o2(), picker, quiltingData, 2));
                }
                if (quiltingReportWrapper.getMo902() != null && quiltingReportWrapper.getMo902() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MOSHULT_90.toString(), quiltingReportWrapper.getMo902(), quiltingReportWrapper.getMo90o2(), picker, quiltingData, 2));
                }
                if (quiltingReportWrapper.getMo1402() != null && quiltingReportWrapper.getMo1402() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MOSHULT_140.toString(), quiltingReportWrapper.getMo1402(), quiltingReportWrapper.getMo140o2(), picker, quiltingData, 2));
                }
                if (quiltingReportWrapper.getMo1602() != null && quiltingReportWrapper.getMo1602() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MOSHULT_160.toString(), quiltingReportWrapper.getMo1602(), quiltingReportWrapper.getMo160o2(), picker, quiltingData, 2));
                }
                break;
            case (3):
                if (quiltingReportWrapper.getMa753() != null && quiltingReportWrapper.getMa753() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MALFORS_75.toString(), quiltingReportWrapper.getMa753(), quiltingReportWrapper.getMa75o3(), picker, quiltingData, 3));
                }
                if (quiltingReportWrapper.getMa803() != null && quiltingReportWrapper.getMa803() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MALFORS_80.toString(), quiltingReportWrapper.getMa803(), quiltingReportWrapper.getMa80o3(), picker, quiltingData, 3));
                }
                if (quiltingReportWrapper.getMa903() != null && quiltingReportWrapper.getMa903() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MALFORS_90.toString(), quiltingReportWrapper.getMa903(), quiltingReportWrapper.getMa90o3(), picker, quiltingData, 3));
                }
                if (quiltingReportWrapper.getMa1403() != null && quiltingReportWrapper.getMa1403() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MALFORS_140.toString(), quiltingReportWrapper.getMa1403(), quiltingReportWrapper.getMa140o3(), picker, quiltingData, 3));
                }
                if (quiltingReportWrapper.getMa1603() != null && quiltingReportWrapper.getMa1603() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MALFORS_160.toString(), quiltingReportWrapper.getMa1603(), quiltingReportWrapper.getMa160o3(), picker, quiltingData, 3));
                }
                if (quiltingReportWrapper.getMo753() != null && quiltingReportWrapper.getMo753() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MOSHULT_75.toString(), quiltingReportWrapper.getMo753(), quiltingReportWrapper.getMo75o3(), picker, quiltingData, 3));
                }
                if (quiltingReportWrapper.getMo803() != null && quiltingReportWrapper.getMo803() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MOSHULT_80.toString(), quiltingReportWrapper.getMo803(), quiltingReportWrapper.getMo80o3(), picker, quiltingData, 3));
                }
                if (quiltingReportWrapper.getMo903() != null && quiltingReportWrapper.getMo903() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MOSHULT_90.toString(), quiltingReportWrapper.getMo903(), quiltingReportWrapper.getMo90o3(), picker, quiltingData, 3));
                }
                if (quiltingReportWrapper.getMo1403() != null && quiltingReportWrapper.getMo1403() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MOSHULT_140.toString(), quiltingReportWrapper.getMo1403(), quiltingReportWrapper.getMo140o3(), picker, quiltingData, 3));
                }
                if (quiltingReportWrapper.getMo1603() != null && quiltingReportWrapper.getMo1603() > 0) {
                    ...
                    listToModify.add(new QuiltedIndex(Cover.MOSHULT_160.toString(), quiltingReportWrapper.getMo1603(), quiltingReportWrapper.getMo160o3(), picker, quiltingData, 3));
                }
        }
    }
